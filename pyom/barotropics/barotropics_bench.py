...
class simulation(PyOM):
   ...
   def randomSetup(self):
       ...
       self.line_psin = np.array([[0.00049516, -0.00049516], [-0.00080039,0.00080039]])

       self.rho[...]        = np.random.rand(self.nx+4, self.ny+4, self.nz, 3)
       self.int_drhodT[...] = np.random.rand(self.nx+4, self.ny+4, self.nz, 3)
       self.int_drhodS[...] = np.random.rand(self.nx+4, self.ny+4, self.nz, 3)
       self.Nsqr[...]       = np.random.rand(self.nx+4, self.ny+4, self.nz, 3)
       self.Hd[...]         = np.random.rand(self.nx+4, self.ny+4, self.nz, 3)
       self.dHd[...]        = np.random.rand(self.nx+4, self.ny+4, self.nz, 3)

       self.maskT[...] = np.random.rand(self.nx+4, self.ny+4, self.nz)
       self.maskU[...] = np.random.rand(self.nx+4, self.ny+4, self.nz)
       self.maskV[...] = np.random.rand(self.nx+4, self.ny+4, self.nz)
       self.maskW[...] = np.random.rand(self.nx+4, self.ny+4, self.nz)
       self.maskZ[...] = np.random.rand(self.nx+4, self.ny+4, self.nz)

       self.cost[...] = np.random.rand(self.ny+4)
       self.cosu[...] = np.random.rand(self.ny+4)
       self.dyu[...]  = np.random.rand(self.ny+4)
       self.dxu[...]  = np.random.rand(self.nx+4)
       self.dpsi[...] = np.random.rand(self.nx+4, self.ny+4, 3)
       self.dyt[...] = np.random.random_sample(self.dyt.shape)
       self.dxt[...] = np.random.random_sample(self.dxt.shape)
